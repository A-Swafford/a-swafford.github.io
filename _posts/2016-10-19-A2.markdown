...
<details> 
  ...
  <ul>
   <li>Remember to import the modules with ‘import random’ and ‘import numpy’.
   <li>Using ‘list.append(value)’ will put additional values into an existing list.
   <li>While loops are your friends!
  </ul>
</details>  
<details> 
